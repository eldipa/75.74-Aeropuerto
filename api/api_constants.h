...
#define CAPACIDAD_CINTA_CHECKIN 10
#define CAPACIDAD_CINTA_SCANNER 10
#define CAPACIDAD_CINTA_CENTRAL 10
#define CAPACIDAD_CINTA_CONTENEDOR 10
...
#define CANTIDAD_MAX_PRODUCTORES_CINTA_CENTRAL 6  // 4 escaners, 1 control_equipaje, 1 robot_intercargo
#define CANTIDAD_MAX_CONSUMIDORES_CINTA_CENTRAL 3 // 1 control_equipaje
...
#define TAMANIO_MEMORIA_CINTA_CARGA (10 * sizeof(int) + sizeof(int)* (CANTIDAD_MAX_CINTAS_CONTENEDOR + CANTIDAD_MAX_CINTAS_CONTENEDOR)+ sizeof(Equipaje) *CAPACIDAD_CINTA_CONTENEDOR)
