...
ApiControlEquipajes::ApiControlEquipajes(int pos_consumidor_cinta_central, const char* path_to_cinta_central, int id_cinta_central) :
   pos_consumidor_cinta_central(pos_consumidor_cinta_central),
   cinta_central(path_to_cinta_central,id_cinta_central) {
}
