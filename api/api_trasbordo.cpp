...
VueloTrasbordo ApiTrasbordo::proximo_vuelo_trasbordo() {
	...
	if (work_queue.pull(&proximo_trasbordo, sizeof(VueloTrasbordo), id_robot)
			== sizeof(VueloTrasbordo)) {
...
ApiTrasbordo::ApiTrasbordo(int id_robot, const char* path_to_trasbordo,
                           const char* path_to_cinta_central, int id_cinta_central) :
		id_robot(id_robot), path_to_trasbordo(path_to_trasbordo), cinta(path_to_cinta_central, id_cinta_central) {
}
