...
static char id [10];
static char * archivo_equipaje_intercargo = (char *)"./entrada/equipajes_intercargo.csv";
...

{
	...
	sem_set = new SemaphoreSet(std::string(directorio_de_trabajo).append(PATH_PUESTO_CHECKIN).c_str(),
		id_checkin * cant_ipcs, 1);
