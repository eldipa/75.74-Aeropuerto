...
int main( int argc, char** argv ) {
   ...
   for(;;) {
      ...
      Log::info("Nuevo vuelo de trasbordo %i -> %i", trasbordo.vuelo_origen, trasbordo.vuelo_destino);
      ...
      Log::info("Terminé con los equipajes %i -> %i", trasbordo.vuelo_origen, trasbordo.vuelo_destino);
