...
int main(int argc, char** argv) try {
	...
	if (argc < 2) {
		Log::crit("Insuf parametros para controlador_equipajes_sospechosos,se esperaba (pos_consumidor_cinta_central,pos_productor_cinta_central)\n");
		exit(1);
	}
	...
	for (;;) {
      ...
      Log::info("ControladorEquipajeSospechoso: recibo equipaje %d, limpio y vuelve a cinta central\n",
